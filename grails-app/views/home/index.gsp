    ...
    <div id="content" role="main">
        <section class="row colset-2-its">
            ...
            <ul class="nav nav-tabs">
                <li role="presentation" class="active"><a href="/home/">Geographic View</a></li>
                <li role="presentation"><a href="/home/voter">Voter View</a></li>
            </ul>

            <div class="row>">

                <iframe width="100%" height="520" frameborder="0" src="https://cheriecarto.carto.com/builder/29052e60-284b-11e7-af39-0e3ebc282e83/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
            </div>
